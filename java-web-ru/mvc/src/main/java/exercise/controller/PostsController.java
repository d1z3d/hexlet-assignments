...
public class PostsController {
    ...
    public static void edit(Context context) {
        ...
        var editPostPage = new EditPostPage(post, null);
        context.render("posts/edit.jte", Collections.singletonMap("editPostPage", editPostPage));
    }
    ...
    public static void update(Context context) {
        try {
            ...
            var editPostPage = new EditPostPage(new Post(id, name, body), e.getErrors());
            context.render("posts/edit.jte", Collections.singletonMap("editPostPage", editPostPage)).status(422);
        }
    }
    // END
}
